...
public class Amazed {
	...
	public Amazed(String map, int sequentialSolver, int forkAfter, int animationDelay) {
		...
		else if (sequentialSolver == 3)
			solver = new ForkJoinSolver3(maze, forkAfter);
		else if (sequentialSolver == 4)
			solver = new ForkJoinSolver4(maze, forkAfter);
		else
	 ...
	 */
	public void solve(int poolSize) {
